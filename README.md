# Aplikasi Kasir - Diaz Sparepart Shop

* **Database Eksternal (File I/O)**: Mengambil daftar barang dan harga dari file `stok.txt` secara dinamis.
* **Kalkulasi Otomatis**: Menghitung subtotal berdasarkan harga barang dikali jumlah beli.
